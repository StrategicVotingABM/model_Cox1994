...
class Candidate:
    ...
    #def voteStrategically(self, inElectors):
    #    for e in range(0, nElectors):
    #        elec = inElectors[e]
    #        elec.maxUtility = max(elec.expectedUtility)
    #        elec.nMaxSinCands = elec.expectedUtility.count(elec.maxUtility)
...
class Elector:
    ...
    def expectUtility(self, inCandidates):
        for c in range(0, nCandidates):
            ...
            self.expectedUtility[c] = (1 - cand.winProb) * self.candUtility[c]                
...
for c in range(0, nCandidates):
    ...
    cand.voteStrategically(electors)    
